...
# nohup bash scripts/rm_wocomment.sh > qwen_tool_all_data_180k_3epoch_4096_all_2round_maskstep1_code_wocomment.log 2>&1 &
bsz=1
#501760
output_dir="/mmu_mllm_hdd_2/yifanzhang/models/qwen_tool_all_data_180k_3epoch_4096_all_2round_maskstep1_code_wocomment"
...
swift sft \
    ...
    --dataset /mmu_mllm_hdd_2/yifanzhang/agent_latest_code/scripts/training_data/wo_system_image_180k_filter_w_image_size_filter_wo_some_code_wo_comment.jsonl \
    /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/scripts/training_data/vstar_2step_nooverlap_training_filtered_70k_wo_comment.jsonl \
    /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/scripts/training_data/vstar_2step_zoomin_training_filtered_70k_wo_comment.jsonl \
    /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/scripts/training_data/wo_system_image_180k_filter_w_image_size_filter_wo_some_code_2round_wo_comment.jsonl \
    --train_type full \
    --lora_rank 8 \
    --lora_alpha 32 \
