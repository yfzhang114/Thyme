...
# nohup bash scripts/2round_jiezhetrian.sh > qwen_tool_all_data_200k_w_imagesize_3epoch_4096_all_2round_jiezhe_4096_train.log 2>&1 &
bsz=1
#501760
output_dir="/mmu_mllm_hdd_2/yifanzhang/models/qwen_tool_2round_jiezhe_maxpixel_4096_train"

FPS_MAX_FRAMES=10 \
NPROC_PER_NODE=8 \
MAX_PIXELS=3211264 \
swift sft \
    --model /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/models/qwen_tool_all_data_200k_w_imagesize_3epoch_maxpixel_4096/v0-20250604-131305/checkpoint-2814 \
