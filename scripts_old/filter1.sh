...
# nohup bash scripts/filter1.sh > qwen_tool_all_data_200k_w_imagesize_3epoch_4096_all_2round_code_4ofilter1_true.log 2>&1 &
bsz=1
#501760
output_dir="/mmu_mllm_hdd_2/yifanzhang/models/qwen_tool_all_data_200k_w_imagesize_3epoch_4096_all_2round_code_4ofilter1_true"
