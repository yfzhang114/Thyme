...
# nohup bash scripts/rl/rl_multi_4node_1.sh > 6node_baseline_3072_bsz256_5e_7_ada_kl1e_2.log 2>&1 &
...
# CODE_WEIGHT=0.1 \
# MAX_PIXELS=3211264 \
deepspeed --hostfile=/mmu_mllm_hdd_2/yifanzhang/agent_latest_code/scripts/rl/hostfile_5655_1 \
    ...
    --resume_from_checkpoint /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/models/6node_baseline_3072_bsz256_5e_7_ada_kl1e_2/v1-20250802-101810/checkpoint-200 \
    --use_vllm true \
    --vllm_mode colocate \
    ...
    --logging_steps 1 \
    --output_dir /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/models/6node_baseline_3072_bsz256_5e_7_ada_kl1e_2 \
    --warmup_ratio 0.03 \
