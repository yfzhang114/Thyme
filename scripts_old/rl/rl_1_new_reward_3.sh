...
# nohup bash scripts/rl/rl_1_new_reward_3.sh > rl_ourrldata_fmt_orm_code03_gen4_penalty_105_lr1e_6_maxpixel_bsz128_iter2_wokl_right.log 2>&1 &
sleep 5
# swift rlhf \
...
deepspeed \
    ...
    --reward_funcs fmt_orm vqa_orm code_orm \
    --use_vllm true \
    --vllm_mode colocate \
    ...
    --dataset /mmu_mllm_hdd_2/yifanzhang/high_resolution/RL.jsonl \
    --max_length 10240 \
    ...
    --logging_steps 1 \
    --output_dir /mmu_mllm_hdd_2/yifanzhang/models/tool_final/rl_ourrldata_fmt_orm_code03_gen4_penalty_105_lr1e_6_maxpixel_bsz128_iter2_wokl_right \
    --warmup_ratio 0.05 \
