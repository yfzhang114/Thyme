...
# nohup bash scripts/rl/rl_multi_4node_3.sh > baseline_deepeyes_high_res_image_pixel2048_kl1e_3_lr1e_6_cst_ada_wokl.log 2>&1 &
...
# CODE_WEIGHT=0.1 \
# MAX_PIXELS=3211264 \
deepspeed --hostfile=scripts/rl/hostfile_4013_2 \
    ...
    --logging_steps 1 \
    --output_dir /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/models/baseline_deepeyes_high_res_image_pixel2048_kl1e_3_lr1e_6_cst_ada_wokl \
    --warmup_ratio 0.03 \
