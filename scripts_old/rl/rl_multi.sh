...
# nohup bash scripts/rl/rl_multi.sh > baseline_deepeyes_only_cst05_rep105_bsz144_numgen4_pixel3096.log 2>&1 &
...
# CODE_WEIGHT=0.1 \
MAX_PIXELS=2408448 \
deepspeed --hostfile=/mmu_mllm_hdd_2/yifanzhang/agent_latest_code/scripts/rl/hostfile_4013 \
    ...
    --resume_from_checkpoint /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/models/baseline_deepeyes_highres_cst05_rep105/v22-20250721-215733/checkpoint-600 \
    --reward_funcs fmt_orm vqa_orm cst_orm \
    --use_vllm true \
    --vllm_mode colocate \
    --vllm_max_model_len 12480 \
    ...
    --logging_steps 1 \
    --output_dir /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/models/baseline_deepeyes_highres_cst05_rep105 \
    --warmup_ratio 0.03 \
