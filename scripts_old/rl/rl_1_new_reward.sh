...
# nohup bash scripts/rl/rl_1_new_reward.sh > rl_VerMulti_fmt_orm_gen8_penalty_11_gradnorm05_lr3e_7_bsz128.log 2>&1 &
sleep 5
# swift rlhf \
...
NPROC_PER_NODE=8 \
REWARD_API_ADDRESS=10.48.42.212 \
QWEN_API_PORT=8000 \
VQA_WEIGHT=1 \
FMT_WEIGHT=0.5 \
CODE_WEIGHT=0.1 \
...
deepspeed \
    ...
    --dataset /mllm_hdd/yfzhang/Agent-R1/construct_data/math_and_chart/VerMulti/RL_training.jsonl \
    --max_length 10240 \
    ...
    --logging_steps 1 \
    --output_dir /mmu_mllm_hdd_2/yifanzhang/models/tool_final/rl_VerMulti_fmt_orm_gen8_penalty_11_gradnorm05_lr3e_7 \
    --warmup_ratio 0.0005 \
