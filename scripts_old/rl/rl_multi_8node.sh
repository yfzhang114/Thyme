...
# nohup bash scripts/rl/rl_multi_8node.sh > 8node_baseline_deepeyes_only_cst05_rep105_numgen4_pixel4096_aligner_bsz256_5e_7_codellm_v2_01.log 2>&1 &
...
# CODE_WEIGHT=0.1 \
# MAX_PIXELS=3211264 \
deepspeed --hostfile=/mmu_mllm_hdd_2/yifanzhang/agent_latest_code/scripts/rl/hostfile_5655 \
    ...
    --logging_steps 1 \
    --output_dir /mllm_hdd/yfzhang/Agent-R1/agent_latest_code/models/8node_baseline_deepeyes_only_cst05_rep105_numgen4_pixel4096_aligner_bsz256_5e_7_codellm_01 \
    --warmup_ratio 0.03 \
