...
# nohup bash scripts/rl/rl_ablation/ablatin_3.sh > baseline_final_setting_wo_highres.log 2>&1 &
sleep 5
# swift rlhf \
...
deepspeed \
    ...
    --logging_steps 1 \
    --output_dir /mmu_mllm_hdd_2/yifanzhang/models/tool_ablation/baseline_final_setting_wo_highres \
    --warmup_ratio 0.03 \
